...
![Remcos](assets/imgs/posts/2024-05-01-Remcos/rermcos.gif)
...
![LECmd Result](assets/imgs/posts/2024-05-01-Remcos/lecmd.png)
...
![LECmd Result](assets/imgs/posts/2024-05-01-Remcos/vbscript.png)
...
![embedded 2nd stage as a resource](assets/imgs/posts/2024-05-01-Remcos/rss2.png)

The DLL is decrypted and then loaded into the memory

![resources decryption](assets/imgs/posts/2024-05-01-Remcos/rss_1.png)

Again it uses an `AES` with `ECB` mode to decrypt the embedded resource

![resources decryption](assets/imgs/posts/2024-05-01-Remcos/decrypt_2nd_stage.png)

It loads and executes the first exported type

![resources decryption](assets/imgs/posts/2024-05-01-Remcos/load.png)
...
![persistence](assets/imgs/posts/2024-05-01-Remcos/persist.png)
...
![persistence](assets/imgs/posts/2024-05-01-Remcos/powershell_persist.png)

It has 2 encrypted resources that decrypt and loads it using the same way as earlier.

![embedded resources](assets/imgs/posts/2024-05-01-Remcos/2nd_stage_rss.png)

![loading resource](assets/imgs/posts/2024-05-01-Remcos/load2.png)
...
![InstallUtil.exe](assets/imgs/posts/2024-05-01-Remcos/instalutils.png)
...
![config](assets/imgs/posts/2024-05-01-Remcos/settings.png)
...
![config](assets/imgs/posts/2024-05-01-Remcos/config.png)
...
![API resolving](assets/imgs/posts/2024-05-01-Remcos/dynamic_resolve2.png)
...
![API resolving](assets/imgs/posts/2024-05-01-Remcos/uac_bypass1.png)
