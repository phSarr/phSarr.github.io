...
![Embedded Drivers](assets/imgs/posts/2024-05-01-HermeticWiper/resources_drivers.png)
...
![Certificate](assets/imgs/posts/2024-05-01-HermeticWiper/cert.png)

### Behavioral Analysis

![Setting up Privileges](assets/imgs/posts/2024-05-01-HermeticWiper/hermeticwiper.png)
...
![iorate](assets/imgs/posts/2024-05-01-HermeticWiper/iorate.png)
...
![fragmentation](assets/imgs/posts/2024-05-01-HermeticWiper/fragmentation_behavior.png)

A little while after that we notice the system becomes nonresponsive, not long after, it will force a restart and BOOM!

![missing os](assets/imgs/posts/2024-05-01-HermeticWiper/missingOS.png)
...
![Setting up Privileges](assets/imgs/posts/2024-05-01-HermeticWiper/set_priv.png)

### Initializing Driver
First of all, a check is made to determine which version of the driver will be installed.

![Fingerprint System](assets/imgs/posts/2024-05-01-HermeticWiper/driver_type.png)
...
![Run driver](assets/imgs/posts/2024-05-01-HermeticWiper/run_drv.png)
...
![Disable VSS](assets/imgs/posts/2024-05-01-HermeticWiper/disable_vss.png)

Also, a change in Explorer registry is made to proceed to fragmentation without the user noticing

![change explorer registry](assets/imgs/posts/2024-05-01-HermeticWiper/explorer_reg.png)
...
![Fragmentation](assets/imgs/posts/2024-05-01-HermeticWiper/corrupt_system.png)

Additionally, it deletes the system event logs.

Fragmentation function :

![Fragmentation function](assets/imgs/posts/2024-05-01-HermeticWiper/fragmentation.png)

Some of the avoided files (as well as `ntuser`, `documents` and `settings`) :

![Avoided files](assets/imgs/posts/2024-05-01-HermeticWiper/avoided_files.png)
...
![generate junk data](assets/imgs/posts/2024-05-01-HermeticWiper/gen_random.png)
...
![bindiff](assets/imgs/posts/2024-05-01-HermeticWiper/bindiff.png)
...
![device object](assets/imgs/posts/2024-05-01-HermeticWiper/dvc_obj.png)

It will then go to the lowest device object using `IoGetLowerDeviceObject` and store it in the `FsContext2` :

![fscontext2](assets/imgs/posts/2024-05-01-HermeticWiper/fscontext.png)

That will later be used in the `"DeviceControl"` along with the `IOCTL` :

![ioctl](assets/imgs/posts/2024-05-01-HermeticWiper/ioctl.png)

And using the device object it got earlier, it will perform write/read operations on the disk.

![driver read/write](assets/imgs/posts/2024-05-01-HermeticWiper/drv_read_write.png)
