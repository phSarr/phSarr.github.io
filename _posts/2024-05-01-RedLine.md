...
![Attack flow graph](assets/imgs/posts/2024-05-01-RedLine/attack_flow.png)
...
![code snippet](assets/imgs/posts/2024-05-01-RedLine/code_snippet.png)

Calling `RGB` to decrypt and launch the final payload :

![third stage](assets/imgs/posts/2024-05-01-RedLine/third_stage.png)
...
![debugger check](assets/imgs/posts/2024-05-01-RedLine/anti_debug.png)
...
![gzip](assets/imgs/posts/2024-05-01-RedLine/gzip_reversed_binary.png)

The payload is decrypted and then launched as a new process using these APIs for `process hollowing` :

![APIs](assets/imgs/posts/2024-05-01-RedLine/process_hollowing.png)

Final payload captured in memory :

![payload](assets/imgs/posts/2024-05-01-RedLine/voila.png)
...
![config](assets/imgs/posts/2024-05-01-RedLine/config_key.png)
...
![OS Info](assets/imgs/posts/2024-05-01-RedLine/os_info.png)
...
![unprotect](assets/imgs/posts/2024-05-01-RedLine/unprotect.png)
...
* System Information
  ...
  * Installed Browsers (Name, version and path)
  ...
  ![query browsers](assets/imgs/posts/2024-05-01-RedLine/get_browser.png)
...
![Tasks](assets/imgs/posts/2024-05-01-RedLine/tasks.png)
