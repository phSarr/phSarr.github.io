...
![Attack flow graph](assets/imgs/posts/2024-05-01-BlackCat/vector.png)
...
![black_cat](assets/imgs/posts/2024-05-01-BlackCat/help.png)
...
![black_cat verbose](assets/imgs/posts/2024-05-01-BlackCat/cmd_log.png)

 We can also find the configuration in JSON format:

![black_cat](assets/imgs/posts/2024-05-01-BlackCat/config.png)
...
![named pipe](assets/imgs/posts/2024-05-01-BlackCat/namedpipe2.png )

![PID](assets/imgs/posts/2024-05-01-BlackCat/pid.png)
...
![tokens](assets/imgs/posts/2024-05-01-BlackCat/priv.png)
...
![clsid ref](assets/imgs/posts/2024-05-01-BlackCat/clsid.png)
...
* Getting `UUID` which I believe is used (with Username and PCname) to generate an access token for the victim on the affiliates' site.
  ...
  ![UUID](assets/imgs/posts/2024-05-01-BlackCat/getuuid.png)
...
* Allowing remote-to-local and remote-to-remote symbolic links for `file_work.rs` file which could contain code that is used by ransomware to encrypt files and it is also often used by ransomware to spread to other drives/machines on the infected network.
  ...
  ![symlink](assets/imgs/posts/2024-05-01-BlackCat/symlink.png)
...
![psexec](assets/imgs/posts/2024-05-01-BlackCat/psexec.png)

Here it creates the ransom note on the desktop :

![ransom note](assets/imgs/posts/2024-05-01-BlackCat/recover_txt.png)

![ransom note](assets/imgs/posts/2024-05-01-BlackCat/note.png)

It also creates the short ransom note image that will be set as a desktop background.

![ransom note](assets/imgs/posts/2024-05-01-BlackCat/ransom_png.png)

![ransom note](assets/imgs/posts/2024-05-01-BlackCat/ransom_note.png)
...
![json block](assets/imgs/posts/2024-05-01-BlackCat/json_block.png)

Here the JSON block is being written in the process heap.

![json key](assets/imgs/posts/2024-05-01-BlackCat/json_key.png)

The beginning and end of the encrypted JSON block are bounded with the bytes `19 47 B3 01`.

![writing to file](assets/imgs/posts/2024-05-01-BlackCat/writefile1.png)
...
![config_extractor](assets/imgs/posts/2024-05-01-BlackCat/conf.png)
